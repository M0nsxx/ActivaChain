...
async function main() {
  console.log("🚀 Creando servicios como owner...");
  ...
  console.log("👑 Owner del marketplace:", owner);
  console.log("👤 Nuestra cuenta:", deployer.address);
  console.log("🔍 Somos owner:", owner.toLowerCase() === deployer.address.toLowerCase());
  ...
  // Si no tenemos reputación, intentar crear una certificación
  if (reputation < 100) {
    console.log("\n📜 Creando certificación para tener reputación...");
    try {
