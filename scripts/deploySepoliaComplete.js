...
async function main() {
  console.log("🚀 Desplegando ActivaChains COMPLETO en Sepolia...");
  ...
  try {
    ...
    // 5. Desplegar ReputationSystem
    console.log("\n5️⃣ Desplegando ReputationSystem...");
    ...
    // 6. Desplegar AdvancedReputationSystem
    console.log("\n6️⃣ Desplegando AdvancedReputationSystem...");
    ...
    // 16. Mostrar resumen
    console.log("\n🎉 DEPLOYMENT COMPLETO EXITOSAMENTE!");
    console.log("=" * 50);
    ...
    console.log(`   AdvancedReputation: https://sepolia.etherscan.io/address/${advancedReputationAddress}`);
    console.log(`   Gamification: https://sepolia.etherscan.io/address/${gamificationAddress}`);
    console.log(`   Community: https://sepolia.etherscan.io/address/${communityAddress}`);
    console.log(`   IPFS: https://sepolia.etherscan.io/address/${ipfsAddress}`);
    console.log(`   Notifications: https://sepolia.etherscan.io/address/${notificationsAddress}`);
    console.log(`   ExternalAPI: https://sepolia.etherscan.io/address/${externalAPIAddress}`);

    console.log("\n🚀 Sistema completo funcional (ETH, ARB) - SIN USDC");
